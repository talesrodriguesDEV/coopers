...
export default function GetInTouch() {
  ...
  return (
    <section className='flex flex-col items-center mb-10 lg:mb-20 xl:text-base'>
      ...
      <form onSubmit={handleSubmit} className='w-11/12 lg:w-3/5 flex flex-col items-center shadow-[0_8px_16px_0_rgba(6,21,43,0.08)] pt-24 pb-10'>
