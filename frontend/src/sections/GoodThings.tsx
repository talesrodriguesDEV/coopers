...
export default function GoodThings() {
  ...
  return (
    <section className='flex flex-col items-center montserrat -mt-32'>
      ...
      <h1 className='text-white absolute left-12 sm:left-24 md:left-32 lg:left-1/4 xl:left-1/3 mt-2 font-extrabold text-lg lg:mt-6 lg:text-3xl'>
        good things
      </h1>
      <div
        onTouchStart={handleTouchStart}
        onTouchEnd={handleTouchEnd}
        className='absolute w-3/4 max-w-[700px] mt-10 lg:mt-20 rounded-lg overflow-hidden drop-shadow-[8px_8px_24px_rgba(12,41,208,0.16)] bg-white'
      >
